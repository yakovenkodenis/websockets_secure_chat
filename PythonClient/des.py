...
class BaseDes(object):
    ...
    def getMode(self):
        """getMode() -> des.ECB or des.CBC"""
        return self._mode

    def setMode(self, mode):
        """Sets the type of crypting mode, des.ECB or des.CBC"""
        self._mode = mode
    ...
    def getPadMode(self):
        """getPadMode() -> des.PAD_NORMAL or des.PAD_PKCS5"""
        return self._padmode

    def setPadMode(self, mode):
        """Sets the type of padding mode, des.PAD_NORMAL or des.PAD_PKCS5"""
        self._padmode = mode
        ...
        if padmode == PAD_NORMAL:
            ...
            if not pad:
                raise ValueError(
                    ...
                    str(self.block_size) + ' bytes in length. ' +
    ...
    def _guardAgainstUnicode(self, data):
        ...
        # otherwise there is no way to correctly decode
        # the data into bytes.
        if isinstance(data, str):
            ...
            try:
                ...
                pass
            raise ValueError(
                'des can only work with encoded strings, not Unicode.')
...
class DES(BaseDes):
    ...
    def __create_sub_keys(self):
        """Create the 16 subkeys K[1] - K[16] from the given key"""
    ...
    def __des_crypt(self, block, crypt_type):
        ...
        # Encryption starts from Kn[1] through Kn[16]
        ...
        while i < 16:
            ...
            # XOR R[i-1] with K[i], create B[1] to B[8] whilst here
            ...
            # Permutate the concatenation pf B[1] to B[8] (Bn)
